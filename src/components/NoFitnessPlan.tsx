  ...
  return (
    <div className="relative backdrop-blur-sm border border-border rounded-lg p-10 text-center">
      ...
      <h2 className="text-2xl font-bold mb-4 font-mono">
        <span className="text-[var(--primary)]">No</span> fitness plans yet
      </h2>
      ...
      <Button
        size="lg"
        asChild
        className="relative overflow-hidden bg-[var(--primary)] text-[var(--primary-foreground)] px-8 py-6 text-lg font-medium"
      >
